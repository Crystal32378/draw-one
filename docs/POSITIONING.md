...
**Last updated:** 2026-08-17 12:45 (Asia/Taipei)
...
|---|---|---|---|---|
| 觀音一百籤 | **Production/reference：艋舺龍山寺百首版**；Historical：京都大學／早稻田（元三大師系）＋南宋天竺靈籤 | 🟢 | 台灣 living-tradition（艋舺龍山寺）＋跨國寺院刊刻（天竺寺 → 日本寺院刊本 → 日數位典藏） | 台灣使用者讀艋舺 living-tradition text；provenance layer 保留歷史與其他版本 |
...
- **Provenance layer**＝ 保留其他版本（鹿港／大陸／廣東／福建）與歷史來源（南宋天竺靈籤／日本元三大師系）作為 lineage evidence
- **chance.org.tw（籤詩網）**＝ secondary transcription，保留作 comparison witness（不刪除、不當 production source）
- **TRANSCRIPTION_PENDING**：現有 100/100 文本尚未逐籤依艋舺版核對——不假裝已完成切換
- 薛皓文 2007 論文附錄二 ＝ transcription/comparison evidence，非 historical primary source
...
具體而言，AI interpretation 以**所選 reference edition（艋舺龍山寺版）**為文本基礎，**不自行融合不同版本**；版本與歷史差異透過 provenance metadata 呈現，不混進正文。
